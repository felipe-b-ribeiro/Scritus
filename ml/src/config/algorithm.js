...
export const K_NEIGHBORS = parseInt(process.env.K_NEIGHBORS, 10) || 5;
export const DEFAULT_RECOMMENDATIONS =
  parseInt(process.env.DEFAULT_RECOMMENDATIONS, 10) || 10;
...
export const FOLLOWED_AUTHOR_BONUS =
  parseFloat(process.env.FOLLOWED_AUTHOR_BONUS) || 2;
